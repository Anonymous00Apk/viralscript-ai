...
// 🆕 V3.2: modelo do Gemini configurável. O Google aposenta modelos com
...
// V3.2: a chave do Gemini é enviada via HEADER x-goog-api-key (método
// documentado pelo Google, compatível com chaves "AIza..." e o novo formato
// "AQ...."). O modelo usado vem de GEMINI_MODEL (env AI_GEMINI_MODEL).
// 🆕 V3.2: thinkingConfig com thinkingBudget: 0 — o gemini-3.6-flash é um
// modelo "thinking" (raciocina antes de responder) e ultrapassava os 25s da
// function. Desativar o raciocínio interno torna a resposta rápida como a
// do 2.5-flash.
