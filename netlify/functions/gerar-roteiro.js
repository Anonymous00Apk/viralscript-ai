...
// 🆕 V3.1: extrai a mensagem REAL do corpo do erro do Google (diagnóstico
// preciso no toast do usuário — essencial para depurar formatos de chave).
...
// 🆕 V3.1: a chave do Gemini é enviada via HEADER x-goog-api-key (método
// documentado pelo Google, compatível com chaves "AIza..." e o novo formato
// "AQ...."). O método antigo "?key=" na URL falhava com HTTP 404 nas chaves novas.
